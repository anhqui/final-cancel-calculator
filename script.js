document.addEventListener("DOMContentLoaded", () => {
  ...
  const handleSubmit = async (e) => {
    ...
    cancelCostEl.textContent = cancelCost.toFixed(2);
    totalCancelCostEl.textContent = totalCancelCost.toFixed(2);
    insuranceUsedCostEl.textContent = insuranceUsedCost.toFixed(2);
